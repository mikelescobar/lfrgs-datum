	...
	<aui:col cssClass="lfr-asset-column lfr-asset-column-details">
		<aui:fieldset-group markupView="lexicon">
			<aui:fieldset>
				...
				<%
					WorkflowInstance editWorkflowInstance = (WorkflowInstance)request.getAttribute(WebKeys.WORKFLOW_INSTANCE);
					String editStartDateText = ""; 
					if ((editWorkflowInstance!=null) && (editWorkflowInstance.getStartDate()!=null)) {
						editStartDateText = editWorkflowInstance.getStartDate().toString();
					}
				%>
				...
				<aui:col width="<%= 25 %>">
					<aui:field-wrapper label="comments">
						<aui:fieldset>
