...
import com.liferay.portal.workflow.web.custom.search.WorkflowInstanceSearch;
import com.liferay.portal.workflow.web.custom.util.WorkflowInstancePortletUtil;
...
public class WorkflowInstanceViewDisplayContext
	...
	public String getComments(WorkflowInstance workflowInstance) {
	...
	public String getOrderByCol() {
		...
		if (Validator.isNull(_orderByCol)) {
			_orderByCol = portalPreferences.getValue(
				WorkflowPortletKeys.CUSTOM_WORKFLOW, "instance-order-by-col",
				"last-activity-date");
		}
		else {
	...
	public String getOrderByType() {
		...
		if (Validator.isNull(_orderByType)) {
			_orderByType = portalPreferences.getValue(
				WorkflowPortletKeys.CUSTOM_WORKFLOW, "instance-order-by-type",
				"asc");
		}
		else {
			boolean saveOrderBy = ParamUtil.getBoolean(request, "saveOrderBy");
