...
package com.liferay.portal.workflow.web.custom.util;
...
import com.liferay.portal.workflow.web.custom.configuration.WorkflowInstanceWebConfiguration;
	...
	public static String getDisplayStyle(
		...
		if (Validator.isNull(displayStyle)) {
			...
			displayStyle = portalPreferences.getValue(
				WorkflowPortletKeys.CUSTOM_WORKFLOW, "instance-display-style",
