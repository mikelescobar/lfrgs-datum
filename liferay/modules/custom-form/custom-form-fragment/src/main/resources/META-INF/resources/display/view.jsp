...
<%@ page import="com.liferay.custom.form.service.CustomFormServiceUtil" %>
...
if (formInstanceId!=0) {
	alreadySent = CustomFormServiceUtil.isSent(formInstanceId, screenName);
}
%>
...
<c:choose>
	...
	<c:when test="<%=alreadySent %>">
		<div class="alert alert-info">
			<liferay-ui:message key="form-already-sent" />
		</div>
	</c:when>
